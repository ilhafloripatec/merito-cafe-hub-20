...
export default function Checkout() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Pedido realizado com sucesso!",
        description: `Seu pedido #${orderNumber} foi criado e em breve você receberá mais detalhes por email.`
      });
      ...
      toast({
        ...
        description: error.message || "Não foi possível completar seu pedido. Por favor, tente novamente.",
        variant: "destructive"
      });
    } finally {
      setLoading(false);
